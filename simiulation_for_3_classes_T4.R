...
n_train <- c(600, 600, 600)
n_test  <- c(10000, 10000, 10000)

alpha <- c(0.05, 0.1)
delta <- c(0.1, 0.1)

hnp_split = list(
  c(train = 0.60, threshold = 0.40, error = 0.00),
  c(train = 0.55, threshold = 0.40, error = 0.05),
...
save(
  ...
  conf_hnp,
  boxplot_out,
  file = "simulation_3class_gaussian_hnp_T4.RData"
)