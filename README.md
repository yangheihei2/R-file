...
| Symbol                 | Meaning                                                                                                                                                           |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| $R_k^{\star}$          | Mean under-classification error for class $k$. In the tables, $R_1^{\star}$ and $R_2^{\star}$ are R1_star and R2_star.                                            |
...
`T1`--`T4` are the H-NP results from `simulation_for_3_classes_T1.R` through `simulation_for_3_classes_T4.R`; 
`C1` is the Classical baseline from `simulation_for_3_classes_T1.R` (identical for T1--T3), and `C2` is the Classical baseline from `simulation_for_3_classes_T4.R`.
